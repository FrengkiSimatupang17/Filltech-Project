    ...
    return (
        <GuestLayout>
            ...
            <div className="text-center mb-6">
                ...
                <p className="text-sm text-gray-600">Bergabunglah untuk menikmati layanan kami</p>
            </div>
            ...
            <form onSubmit={submit}>
                ...
                <div className="mt-6">
                    <div className="relative">
                        ...
                        <div className="relative flex justify-center text-sm">
                            <span className="px-2 bg-white text-gray-500 uppercase">Atau daftar dengan</span>
                        </div>
                    </div>
                ...
                <div className="mt-6 text-center text-sm text-gray-600">
                    Sudah punya akun? 
                    <Link href={route('login')} className="font-bold text-blue-600 hover:text-blue-800 ml-1">
                        Masuk disini
                    </Link>
                </div>
            </form>
